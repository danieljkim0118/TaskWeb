...
def evaluate_selection(target_task, source_task_list, task2dir_transfer, roe_info, transfer_info=None, regret_k=None):
...
if __name__ == "__main__":
    ...
    for category, task_list_custom in category2task.items():
        ...
        for target_task in task_list_custom:
            ...
            score, pred_rankings, gold_rankings = evaluate_selection(target_task, source_task_list, task2dir_transfer, roe_info, transfer_info)
            score_topk, pred_rankings, gold_rankings = evaluate_selection(target_task, source_task_list, task2dir_transfer, roe_info, transfer_info, regret_k=5)
            score_avg += score
